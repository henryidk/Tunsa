...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'renta-retroactiva',
        label: 'Renta Retroactiva',
        icon: (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      },
      {
        ...
        icon: (
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <circle cx="5" cy="6" r="1.5"/><line x1="9" y1="6" x2="20" y2="6"/>
            <circle cx="5" cy="12" r="1.5"/><line x1="9" y1="12" x2="20" y2="12"/>
            <circle cx="5" cy="18" r="1.5"/><line x1="9" y1="18" x2="20" y2="18"/>
          </svg>
        ),
      },
    ],
...
const EncargadoSidebar = memo(function EncargadoSidebar({ activeSection, onNavTo, collapsed, onToggle, onLogout, user }: Props) {
...
export default EncargadoSidebar;
