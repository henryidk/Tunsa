...
import { TONO_AMBAR } from '../../types/tono.types';
...
export default function EncargadoDashboard() {
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case 'proyectos':       return <ProyectosSectionShared tono={TONO_AMBAR} onNavTo={navTo} />;
      case 'vencidas':        return <VencidasSection initialFolio={navState.folio} onNavTo={navTo} />;
      case 'historial':       return <HistorialSection />;
      case 'flota':           return <DisponibilidadFlotaSection tono={TONO_AMBAR} onNavTo={navTo} />;
